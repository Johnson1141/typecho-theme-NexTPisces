$(document).ready(function () {
  ...
  NexT.motion.middleWares =  {
    ...
    postList: function (integrator) {
      ...
      var hasPost = $sidebarAffix.size() > 0;
      ...
      function postMotion () {
        ...
        postMotionOptions.begin = function () {
        ...
        $sidebarAffix.velocity('transition.slideUpIn', postMotionOptions);   
        /*
        console.log($(".sidebar").has(".affix-top").length);
      	if( $(".sidebar").has(".affix-top").length) $('.sidebar').velocity('transition.slideUpIn', postMotionOptions);      
        else $('.sidebar').css({ 'opacity': 1 });
        */
      }
